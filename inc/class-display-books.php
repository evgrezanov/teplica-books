		...
		?>
			<div class="card mb-3" style="max-width: 540px;">
  				<div class="row no-gutters">
    				<div class="col-md-4">
      					<img src="<?php echo get_the_post_thumbnail_url( $post->ID, 'full' ) ?>" class="card-img" alt="<?php the_title(); ?>">
    				</div>
    				<div class="col-md-8">
      					<div class="card-body">
							...
							<p class="card-text"><small class="text-muted">Дата издания: <?php echo $publish_date; ?></small></p>
							<?php endif; ?>
	...
	public static function single_book_content($content){
		...
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="card mb-3">
  						<img src="<?php echo get_the_post_thumbnail_url( $post->ID, 'full' ) ?>" class="card-img-top" alt="<?php echo $post->post_title; ?>">
  						<div class="card-body">
